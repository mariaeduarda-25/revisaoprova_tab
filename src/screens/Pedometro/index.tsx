...
export default function Pedometro() {
    ...
    const [isPedometerAvailable, setIsPedometerAvaliable] = useState('checking')
    ...
    const _subscribe = () => {
        ...
        Pedometer.isAvailableAsync().then(
            result => {
                setIsPedometerAvaliable(String(result));
            },
            error => {
                setIsPedometerAvaliable('Could not get isPedometerAvailable: ' + error)
            }
        );
